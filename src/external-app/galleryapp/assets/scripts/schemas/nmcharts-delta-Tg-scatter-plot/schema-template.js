        ...
        const returnSchema = {
          ...
          "vconcat":[
            ...
            "selection": {
              ...
              "myselect":{"type":"multi","fields": ["Matrix"]}
            },    
            ...
            "usermeta": {
              ...
              "description": "Selecting any point in the scatter plot highlights all other points containing the same matrix material and also highlights the corresponding density plot below. SHIFT+click allows selection of multiple series. Glass transition temperature (Tg) was normalized by subtracting the Tg of the neat matrix from the Tg of the nanocomposite."
            }
        }
