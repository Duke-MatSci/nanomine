...
try
    ...
    if str2num(input_type) ~= 2
        ...
        %%Umar added to deal with odd shaped images + otsu binarization
        ...
        Target_img=Target_img(1:L1,1:L2);
    ...
    for i = 1:num_recon
        ...
        recon_corrf(:,i) = calc_Corr(Recon_img,correlation_choice);
    ...
    try
        ...
        %Create legend names
        for i = 1 : num_recon
            plot( 0:1:length(recon_corrf)-1, recon_corrf(:,i), 'LineWidth',2.5);
