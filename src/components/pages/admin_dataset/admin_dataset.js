...
export default {
  ...
  methods: {
    ...
    toggleDatasetHide: function () {
      this.datasetHideSelector = !this.datasetHideSelector
      this.datasetSelected = null
      this.filesHideSelector = true
      this.filesetsHideSelector = true
    ...
    toggleFilesetsHide: function () {
      this.filesetsHideSelector = !this.filesetsHideSelector
      this.filesetSelected = null
      this.fileSelected = null
      console.log('filesetsHideSelector: ' + this.filesetsHideSelector)
    },
