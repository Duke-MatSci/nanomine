...
# Description:
#
# Modified by: Akshay Iyer, August 15, 2018
...
<template>
  <div class="characterization_homepage">
      ...
      <v-layout align-space-between justify-center row fill-height>
        <v-flex>
            ...
            <div>
              ...
              <p> Physical descriptors (aka features/predictors) provide a meaningful and convenient approach for direct elucidation of Processing-Structure-Property relations.
    ...
    <v-flex xs12>
        ...
        <p>Xu, H., Dikin, D.A., Burkhart, C. and Chen, W., 2014. Descriptor-based methodology for statistical characterization and 3D reconstruction of microstructural materials. Computational M
     </v-flex>
  </div>
</template>
