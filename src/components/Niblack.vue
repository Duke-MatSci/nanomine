  ...
  data: () => {
    return {
      jobInfo: {
        ...
        description: [
          'Niblack is a local thresholding method for binarization which involves computing for each pixel in the grayscale image the mean and standard devation of the colors of the neighboring pixels in an area (WINDOW SIZE) of predefined size.',
